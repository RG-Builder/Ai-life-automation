    ...
    <div className="min-h-screen bg-black text-[#00FF41] font-mono selection:bg-[#00FF41]/30 flex flex-col relative overflow-hidden">
      ...
      <AnimatePresence>
        {error && (
          ...
          >
            <div className="bg-black border border-[#00FF41]/50 rounded-none p-4 shadow-[0_0_20px_rgba(0,255,65,0.2)] flex items-center gap-3">
              <AlertCircle className="text-[#00FF41] shrink-0" size={20} />
              <p className="text-xs text-[#00FF41] flex-1 uppercase tracking-widest">{error}</p>
              <button onClick={() => setError(null)} className="text-[#008F11] hover:text-[#00FF41]">
                <X size={16} />
              </button>
            </div>
          </motion.div>
